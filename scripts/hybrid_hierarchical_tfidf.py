...
print(f"  Grants with terms: {has_terms.sum():,} ({has_terms.mean()*100:.1f}%)")
...
try:
    ...
    print(f"  Top 20 distinctive terms:")
...
if best['silhouette'] > -0.0003:
    ...
    print(f"  Note: Still weak but expected for biomedical continuum")
...
print("=" * 70)
print(f"\nNext steps:")
print(f"1. Apply clustering: Modify apply_hierarchical_clustering.py to use hybrid features")
print(f"2. Scale to full 50k sample with optimized parameters")
print(f"3. Generate UMAP visualization")
