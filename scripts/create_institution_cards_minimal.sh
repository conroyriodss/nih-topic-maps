...
echo "=========================================="
echo "CREATING INSTITUTION CARDS (MINIMAL)"
echo "Using only available fields"
echo "=========================================="
echo ""

# Step 1: Institutional Temporal Trends
echo "[1/3] Creating institutional temporal trends..."
...
echo ""
echo "[2/3] Analyzing institutional specialization..."
...
# Step 3: Comprehensive Institution Cards
echo ""
echo "[3/3] Assembling comprehensive institution cards..."
...
echo ""
echo "=========================================="
echo "✅ INSTITUTION CARDS CREATED"
echo "=========================================="
echo ""
echo "Tables created:"
echo "  - institution_temporal_trends"
echo "  - institution_specialization"
echo "  - institution_cards_complete"
echo ""
echo "Summary of top 10:"
bq query --use_legacy_sql=false << 'EOSQL'
SELECT 
  institution,
  ...
  center_total,
  fellowship_total
FROM `od-cl-odss-conroyri-f75a.nih_analytics.institution_cards_complete`
